      ...
      >
        ...
        <ul class="menu-nav">
          ...
          <router-link
            :to="{name: 'users'}"
            class="menu-item"
            :class="{'menu-item-active': $route.path === '/users'}"
          >
            <a
              href="#"
              class="menu-link"
          ...
          <router-link
            :to="{name: 'internal-users'}"
            class="menu-item"
            :class="{'menu-item-active': $route.path === '/internal-users'}"
          >
            <a
              href="#"
              class="menu-link"
          ...
          <router-link
            :to="{name: 'trainings'}"
            class="menu-item"
            :class="{'menu-item-active': $route.path === '/trainings'}"
          >
            <a
              href="#"
              class="menu-link"
          ...
          <router-link
            ...
            class="menu-item"
            :class="{'menu-item-active': $route.path === '/applications'}"
          >
            <a
              href="#"
              class="menu-link"
          ...
          <router-link
            :to="{name: 'pages'}"
            class="menu-item"
            :class="{'menu-item-active': $route.path === '/pages'}"
          >
            <a
              href="#"
              class="menu-link"
